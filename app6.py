...
def generate_crypto_question_google():
    ...
    prompt = f"""
        Genera una única pregunta de quiz sobre tres conceptos fundamentales de la teoría de conjuntos: conjuntos por comprensión, conjuntos por extensión, inclusión.
