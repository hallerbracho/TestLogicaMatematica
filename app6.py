...
model = genai.GenerativeModel(
    model_name="gemini-2.5-flash-preview-04-17", # Usando gemini-1.5-flash
    generation_config={
...
def generate_crypto_question_google():
    ...
    prompt = f"""
        Genera una única pregunta de quiz relacionado con conjuntos por extensión y comprensión para estudiantes de lógica matemática. 
