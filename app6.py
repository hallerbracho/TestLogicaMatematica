...
def generate_crypto_question_google():
    ...
    prompt = f"""
        Genera una única pregunta de quiz sobre los Fundamentos de la teoría de conjuntos (específicamente sobre conjuntos por comprensión, conjuntos por extensión, inclusión).
