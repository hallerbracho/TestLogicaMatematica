...
model = genai.GenerativeModel(
    ...
    generation_config={
        ...
        "temperature": 0.6 # Añadir temperatura para algo de variabilidad
    },
...
def generate_crypto_question_google():
    ...
    prompt = f"""
        Genera una única pregunta de quiz sobre la asignatura Fundamentos prácticos de curvas de calibración (química analítica).
