...
def generate_crypto_question_google():
    ...
    prompt = f"""
        Genera una única pregunta de quiz sobre la asignatura: Preguntas de razonamiento sobre conjuntos por extensión y comprensión para estudiantes de programación. 
