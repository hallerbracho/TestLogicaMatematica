...
def generate_crypto_question_google():
    ...
    prompt = f"""
        Genera una única pregunta de quiz sobre la asignatura Fundamentos básicos de la Teoría de Conjuntos para estudiantes del primer semestre de la Licenciatura en Computación. La pregunta debe venir acompañada con un escenario teórico (máximo 1-2 párrafos) relacionado con la pregunta. 
