...
def generate_crypto_question_google():
    ...
    prompt = f"""
        Genera una única pregunta de quiz sobre la asignatura Ejercicios prácticos de conjuntos (union, intersección, diferencia, diferencia simétrica, complemento, producto cartesiano).
