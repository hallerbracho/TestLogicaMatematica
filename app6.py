...
model = genai.GenerativeModel(
    ...
    generation_config={
        ...
        "temperature": 0 # Añadir temperatura para algo de variabilidad
    },
...
def generate_crypto_question_google():
    ...
    prompt = f"""
        Genera una única pregunta de quiz sobre operaciones con conjuntos (unión, intersección, diferencia, diferencia simétrica, complemento) y Leyes de Morgan. 
...
with st.container():
    ...
    st.markdown(f"**{st.session_state.max_questions} preguntas** para practicar los conceptos de la clase (operaciones con conjuntos).") # Desc actualizada
    #st.divider()
